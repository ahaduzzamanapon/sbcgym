...
<div class="row">
    ...
    <div class="form-group col-md-4">
        {!! Form::label('status', 'Pay Status:', ['class' => 'control-label']) !!}
        {!! Form::select('pay_status', ['' => 'Select Status', '1' => 'Pending', '2' => 'Due', '3' => 'Full Paid'], null, [
            'class' => 'form-control',
            'readonly',
            'required' => 'required',
        ]) !!}
    ...
    <div class="form-group col-md-4">
        {!! Form::label('status', 'Locker Status:', ['class' => 'control-label']) !!}
        {!! Form::select('locker_status', ['active' => 'Active', ' expired' => ' Expired'], null, ['class' => 'form-control']) !!}
    </div>
